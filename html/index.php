...
<nav>
    <div class="container">
        <div class="box principal">
            ...
            <div style="color:#2D222F;"><p>Section one </p></div>
            <div style="color: #2D222F ;" ><i class='bx bxs-group' ></i><p>group <span>10</span></p></div>
        </div>
        <div class="box secondair">
            <div class="name"><i class='bx bxs-user'></i><p>Naseri Farouk</p></div>
            <div class="eemail">
        ...
        <div class="box secondair">
            <div class="name"><i class='bx bxs-user'></i><p>Yousfi Nacer</p></div>
            <div class="eemail">
        ...
        <div class="box secondair">
            <div class="name"><i class='bx bxs-user'></i><p>Bouras Ayoub</p></div>
            <div class="eemail">
